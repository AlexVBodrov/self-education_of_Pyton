...
win = tk.Tk()
#photo = tk.PhotoImage(file=".img\\p_icon.png")
#win.iconphoto(False, photo)
win.title("Калькулятор")

win.geometry("240x300")
win.resizable(width=False, height=False)
win.configure(bg='#748491')
...
calc = tk.Entry(win, bd=10, font=('Arial', 16), justify=tk.RIGHT, width=15)
calc.insert(0, '0')
...
def make_clear_button():
    return tk.Button(text='C', bd=5, font=('Arial', 13), command=make_clear)
